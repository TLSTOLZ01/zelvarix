export default async function handler(req, res) {
  ...
  try {
    ...
    // Map NAICS codes to PDL canonical industry strings
    const NAICS_TO_PDL = {
      ...
      "9281": "defense & space", "3364": "aviation & aerospace",
      "7372": "computer software", "5613": "staffing and recruiting",
    ...
    // NAICS → PDL industry mapping (takes priority over text filter)
